...
public class ImageLoaderOptions {
    ...
    private boolean needImageRadius = false;//圆角
    ...
    private ImageLoaderOptions(Builder builder) {
        ...
        this.needImageRadius = builder.needImageRadius;
    ...
    public final static class Builder {
        ...
        private boolean needImageRadius = false;
        private int imageRadius = 0;
        private boolean isCircle = false;
        ...
        public Builder needImageRadius(boolean needImageRadius) {
            this.needImageRadius = needImageRadius;
            return this;
        }
